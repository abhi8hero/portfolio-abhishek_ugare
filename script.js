...
function loadProject(p) {
  const data = {
    p1: [
      "HotelRevAI is a data-driven project developed as part of the Infosys Springboard Data Visualisation Internship 6.0. This project focuses on transforming raw hotel data into meaningful insights that help in improving revenue strategies, occupancy rates, and overall business performance. It is a team project, where collaboration, idea-sharing, and collective problem-solving played a key role in delivering impactful dashboards and analysis.",
      "Power BI",
      "This project was successfully completed as a team effort, where each member contributed to Data cleaning and preparation, Dashboard design and visualization, Insight generation and analysis and Presentation and documentation. Collaboration and communication were key factors in achieving the final outcome.",
      "reports/hotelrevai-report.pdf"
    ],
    p2: [
